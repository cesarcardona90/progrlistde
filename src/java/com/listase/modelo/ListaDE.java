...
public class ListaDE  implements Serializable{
    ...
    public void adicionarNodoDE(Infante infante)
    {
        ...
        
        {
            //Lamo a mi ayudante
            NodoDE temp= cabeza;
            while(temp.getAnterior()!=temp.getSiguiente()) //Mientras que en siguiente exista algo
            {
                temp = (NodoDE) temp.getAnterior();
            }
            //temp va estar ubicado en el ultimo nodo
            temp.setAnterior(new NodoDE(infante));
        }
    }
